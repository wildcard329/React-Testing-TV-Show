...
import { fetchShow as mockFetchShow } from "./components/api/fetchShow";
...
test("clicking on the button fetches data and renders it to the DOM", async () => {
    ...
    await waitFor(() =>
        expect(queryAllByTestId(/episode-list/i)).toHaveLength(1)
    );
